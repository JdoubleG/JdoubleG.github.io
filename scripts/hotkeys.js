...
/* listen
 * Records which key is pressed on the keyboard and determines which helper function to call.  */
function listen(event)
{
    /* beep(); */
    var char = event.keyCode;
    if (char == 72) home();
    else if (char == 65) about();
    else if (char == 80) projects();
    else if (char == 76) links();
    else if (char == 67) contact();
    /* beep(); */
}
