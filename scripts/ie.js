/* ie.js -- Checks to see if the user is using Internet Explorer, early Edge, or
 *          some other browser that uses either Trident or EdgeHTML as its
 *          rendering engine. These browsers do not display JamesGG.net
 *          correctly with consistency.
 *
 * Written by:  James Garijo-Garde
 *         for: Exclusive personal use
 *         on:  5/24/2018 - 12/23/2021
 */
